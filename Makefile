...
demuter-main.o:	src/systems/demuter/demuter-main.c
	@echo "  [CC] demuter-main.c"
	@$(CC) $(CFLAGS) $(WARN) $(ERR) $(OPT) $(DBG) $(INC) -c src/systems/demuter/demuter-main.c -o demuter-main.o
